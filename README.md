...
![HOME PAGE](./assets/reademeimg/Imresponsive.png)

# UX

I aimed for a visually appealing website that has a bodybuilding theme with a  pages flow  easy and intuitive. Diffrent text, images are linked with related pages by a click. The color scheme is keep all over the website, and reading is easy and visible.
the hero images theme on  Home Page   is direct related with the wesite subject, and it has a zoom animations.
...
![HOME PAGE](./assets/reademeimg/Navigation-bar.png)
...
* The Hero images
    ...
    + The navigation bar is giving a smooth navigation from page to page across all devices without having to revert back to previous page via the 'back' button.
     ...
     ![HOME PAGE](./assets/reademeimg/hero-cover-text.png)
...
* The Icons  Section
   ...
   ![HOME PAGE](./assets/reademeimg/icon-pages.png)
...
![HOME PAGE](./assets/reademeimg/competition-section.png)
...
* Footer
  ...
  ![HOME PAGE](./assets/reademeimg/footer.png)
...
![HOME PAGE](./assets/reademeimg/calendar.png)
...
![HOME PAGE](./assets/reademeimg/coaches.png)
...
![HOME PAGE](./assets/reademeimg/gallery.png)
...
![HOME PAGE](./assets/reademeimg/contact-us.png)

![HOME PAGE](./assets/reademeimg/contactus-mobile.png)
